...
# build test states
python build_test_states.py 'test_states.npz' '10000000' '500' '--trajectory-outfile' 'test_states_trajectory.npy' '--interference-outfile' 'interference_test_states.npz' '--interference-sample-size' '180'
