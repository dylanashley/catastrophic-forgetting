...
parser.add_argument("folds", type=int, help="number of folds to build masks for")
...
if len(raw_y_test.shape) != 1:
    raw_y_test = raw_y_test.squeeze()
assert len(raw_y_test.shape) == 1
...
assert raw_y_train.min() == 0
for j in range(raw_y_train.max() + 1):
